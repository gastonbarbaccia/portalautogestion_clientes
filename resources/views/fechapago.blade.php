                ...
                <div class="col">
                    <div class="card rounded-4">
                        <div class="card-body">
                            ...
                            <form action="formapago">
                                <div class="row mb-3">
                                    <div class="col m-2">
                                        <input class="form-control" type="date" id="fecha" min="">
                                    </div>
                                    <div class="col"></div>
                                    <div class="col"></div>
                                    <div class="col"></div>
                                    ...
                                    <div class="row pb-3">
                                        ...
                                        <div class="col"></div>
                                        <div class="col"></div>
                                        <a href="/" class="btn btn-danger col align-self-end rounded-pill me-2">
                                            Cancelar </a>
                                        <button type="submit" class="btn btn-dark col align-self-end rounded-pill">
                                            Siguiente
                                        </button>
                                        <div class="col"></div>
                                    </div>
...
<!-- Datepicker con 24 dias-->
<script>

    // Obtener el input del calendario
    ...
    // Calcular la fecha 24 días en el futuro

    const futureDate = new Date();

    futureDate.setDate(today.getDate() + 24);
    ...
    // Establecer el valor mínimo y máximo en el input

    dateInput.min = formatDate(today);

    dateInput.max = formatDate(futureDate);

    // Mostrar la fecha actual como predeterminada (opcional)
