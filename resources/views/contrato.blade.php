                ...
                <div class="card rounded-4">
                    ...
                    <div class="container pb-4">
                        <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%"
                             ...
                             tabindex="0">
                            <h4 id="scrollspyHeading1">Contrato</h4>
                            <p>Lugar y fecha: Buenos Aires, 16/11/2024.</p>

                            <p>Entre las partes:</p>
                            <p></p>Deudor: Anima Agrawal, con documento de identidad número 35991682.
                            Acreedor: RCI – Consultora</p>

                            <p>MANIFIESTAN:</p>
                            <p>El Deudor manifiesta su compromiso de abonar al Acreedor la cantidad de $1.352,61 en
                                concepto de cancelación de un servicio previamente contratado (BANCO HSBC TARJETA DE
                                CREDITO VISA).</p>
                            <p>Por lo tanto, ambas partes acuerdan las siguientes cláusulas:</p>
                            <p>CLÁUSULAS</p>
                            <p>Monto de la deuda:El Deudor se compromete a pagar al Acreedor la suma total de $
                                1352,61.</p>
                            <p>Plazo y forma de pago:</p>
                            <p>El pago se realizará en un solo pago con fecha 16/11/2024.</p>
                            <p>Comprobante de pago:</p>
                            <p>Una vez realizado el pago el usuario deberá subir el comprobante del pago realizado para
                                dar por cancelada la deuda.</p>
                            <br>
                            <h3>Datos de pago</h3>
                            <ul>
                                <li><strong>CBU:</strong> 12312312312412312</li>
                                <li><strong>Titular:</strong> Jose Argento</li>
                                <li><strong>Banco:</strong> Santander Rio</li>
                            </ul>
                    ...
                    <div class="container mb-2">
                        <div class="row p-3">
                            <div class="col"></div>
                            <div class="col"></div>
                            <a href="/" class="btn btn-secondary col align-self-end rounded-pill me-2"> Descargar </a>
                            <button type="submit" class="btn btn-dark col align-self-end rounded-pill">Finalizar
                            </button>
                        </div>
                    </div>
                </div>
